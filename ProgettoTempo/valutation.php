...
<head>
    ...
    <title>Bonshop: Valutazione</title>
...
echo '<form class="center" method="POST" id="myform">'
...
<?php
    ...
    ?>
        <form class="center" method="POST" action="order.php" id="myform">
