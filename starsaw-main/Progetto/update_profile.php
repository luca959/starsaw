...
<div class='mydiv'>
   <div>
        ...
        <form id='myform' action='profileUpdate.php' method='POST'>
            ...
            <input type='email' id='email' class='no-outline'  name='email' value='<?php echo $email  ?>' onchange='verificaupdate("checkmail.php")' required><br>
            ...
            <div id='updateButtons'>
                ...
                <input type='submit' class='submit' value='Submit' onclick="update_check()">
            </div>
